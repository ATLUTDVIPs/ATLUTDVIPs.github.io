---
layout: page
title: "Tyrone Mears: From Fullback to President of Soccer"
subheadline: "From Stockport to Marseille to MLS Cup - and into the front office"
teaser: "A career built on adaptation and trust, from Europe to MLS Cup to the job of building a club"
categories:
  - ATLUTD
  - Players
  - Retired
...
image_dir: "2026-01-11-Tyrone Mears"
header:
  #image_fullwidth: "examples/header_drop.jpg"
  background-color: "#221F1F;"

image:
  title: 2026-01-11-Tyrone Mears/minneapolis-mn-tyrone-mears-of-atlanta-united-fc-challenges-jermaine-taylor.jpg
  thumb: 2026-01-11-Tyrone Mears/minneapolis-mn-tyrone-mears-of-atlanta-united-fc-challenges-jermaine-taylor.jpg
  homepage: 2026-01-11-Tyrone Mears/minneapolis-mn-tyrone-mears-of-atlanta-united-fc-challenges-jermaine-taylor.jpg
...
status: Written
priority: Low
notes: "Article is ready to go."
blocking: ["Waiting for a response from Fort Lauderdale United"]
dates:
  - label: "Created"
    date: "2025-12-29"
  - label: "Follow-up"
...
> “I signed a contract with Warrington Wolves running from when I was 12 until I was 21. That was where I thought my career was going.”
> <cite>Tyrone Mears, The Guardian, November 4, 2009</cite>
...
> “It was a really tough decision. You see how many young lads want to become footballers and have not really done it. To go to Manchester City was going to be difficult but I’m glad I made that change.”
> <cite>Tyrone Mears, The Guardian</cite>
...
> “It’s difficult to find players that are capable, strong enough and quick enough to play in the Premier League and I think he’s got all of those qualities.”
> <cite>Jim Cassell, Manchester City Academy Manager, mcfc.co.uk</cite>
...
{% include centered_image.html
   file="soccer-axa-fa-cup-third-round-replay-reading-v-preston-north-end.jpg"
...
{% include centered_image.html
   file="preston-united-kingdom-tye-mears-of-preston-north-end-beats-george-boateng-of-middlesbrough.jpg"
...
{% include centered_image.html
   file="derby-united-kingdom-stewart-downing-of-middlesbrough-attempts-to-shoot-past-tyrone-mears-of.jpg"
...
> “We are delighted to complete this deal because Tye is a very good young full-back with excellent pace and potential. We need him for the challenge ahead and I know he is committed to working hard with us because he has the exciting potential to improve still further.”
> <cite>Billy Davies, Derby Manager, quoted via mcfc.co.uk</cite>
...
> “The faxed offer from Marseille yesterday was for a two-day trial, with the possibility of a free loan. That is completely and utterly unacceptable - in fact it’s laughable. ... Both the chairman Adam Pearson and the manager Paul Jewell communicated this to the player directly and to Marseille and made it clear that as the offer stood there would be no deal”
> <cite>Derby County spokesperson, quoted via The Guardian</cite>
...
{% include centered_image.html
   file="marseilles-forward-mamadou-niang-ce.jpg"
...
{% include centered_image.html
   file="burnley-v-west-ham-united-premier-league.jpg"
...
{% include centered_image.html
   file="tyrone-mears-bolton-defender_3321422.jpg"
   caption="Mears, Bolton Wanderers, (Photo by Sky Sports)"
%}
...
{% include centered_image.html
   file="6c438202-2dd0-11e5-addd-33766ec734f4.jpg"
   caption="Seattle defender Tyrone Mears tries to get around the Colorado Rapids’ Juan Ramirez in a July 18 match at CenturyLink Field.<br/>
...
> “People think of MLS as a retirement league, but it’s not. It’s transitional. You have to be fit. If you switch off, you get punished.”
> <cite>Tyrone Mears, Seattle Sounders interview</cite>
...
{% include centered_image.html
   file="2025-03-31 - C5S8_e4WAAQTjru.jpg"
   caption="2017-02-18 - Atlanta United at Columbus Crew, L 2-1, Carolina Challenge Cup Friendly (Photo by ATLUTD)"
%}
...
{% include centered_image.html
   file="SL-Fort-Lauderdale-Tyrone-Mears-2024-01-25_15241130.jpg"
   caption="(Photo by Fort Lauderdale FC)"
%}
...
> "I’m incredibly excited to be chosen to lead at Super League Fort Lauderdale, a fresh and inspiring chapter in women’s professional soccer. My journey in football, rich with diverse experiences, has perfectly set the stage for this new challenge. We’re not just starting a soccer team in Fort Lauderdale; we’re building a community for women athletes who’ve long awaited this opportunity."
> <cite>Mears, bocaratontribune.com</cite>
...
For those interested in seeing the environment Mears is now helping build, Fort Lauderdale United FC is based roughly 20 minutes south of Inter Miami's Chase Stadium. Current schedules, venues, and club information are available at [FTLUTD.com](https://www.ftlutd.com).
...
---
    ...
    {% include player_block.html
      ...
      side_image="left"
      file="Tyrone Mears.jpg"
      caption="(Photo by ATLUTD)"
      league=""
      stats="Seasons: 17|Countries: 3|Clubs: 11|Leagues: 4|Matches: 336|Starts: 294|Minutes: 27,054|Goals: 12|Assists: 15|Yellow Card: 50|Red Cards: 1"
      cite=""
      text="Tyrone Mears played in 22 games for ATLUTD, scoring 1, assisting 1."
    %}
...
{% include Timeline_Crests.html
  ...
  crests="Manchester_City.png|Preston_North_End.png|West_Ham_United.png|Derby_County.png|Marseille.png|Burnley.png|Bolton_Wanderers.png|Seattle_Sounders-2017.png|Atlanta_United.png|Minnesota_United.png|West_Bromwich_Albion.png"
