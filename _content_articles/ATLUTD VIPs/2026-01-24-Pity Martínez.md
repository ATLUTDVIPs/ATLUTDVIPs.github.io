...
# Content
#
subheadline: "Keep following your dream"      # Subheadline = label:  what / where / when
title: "Pity Martínez Completes Transfer to Tigre"               # 
teaser: "Pity Martínez joins Club Atlético Tigre after leaving River Plate on a free transfer, beginning a new stage in Argentina’s top flight."      # Teaser = pitch: why should I care
categories:
  - ATLUTD
  - Player
  - Transfer
...
Asked about the move, he framed it simply:

{% include quote.html 
   mode=""
   quote="'Playing football is my dream. You have to keep going.'
