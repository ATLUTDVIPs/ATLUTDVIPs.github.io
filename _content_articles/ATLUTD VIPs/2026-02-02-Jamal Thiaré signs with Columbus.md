...
# Content
#
subheadline: "Atlanta United receive up to $300,000 in allocation money"      # Subheadline = label:  what / where / when
title: "Jamal Thiaré signs with Columbus Crew"               # 
teaser: "After two and a half seasons and several defining moments in Atlanta, Thiaré moves on as the club reallocates resources elsewhere."      # Teaser = pitch: why should I care
categories:
  - ATLUTD
  - Player
  - Transfer
...
{% include quote.html
    mode=""
    quote="Jamal is an experienced striker who brings a different profile to our squad. He is another asset that will elevate our team as we push towards the start of the season, and we look forward to welcoming Jamal to Columbus."
    speaker="Issa Tall"
    source="Columbus Crew General Manager"
    image=""
%}
