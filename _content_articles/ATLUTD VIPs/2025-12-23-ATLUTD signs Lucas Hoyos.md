---
layout: page
title: "Atlanta United Signs Lucas Hoyos - Risk, Recovery, and a Clear Break from the Past"
subheadline: "What Atlanta United is betting on - and what happens if it doesn’t hold"
teaser: "Experience, uncertainty, and a goalkeeper who changes the terms of play"
categories:
  - ATLUTD
  - Players
  - Signing
...
Atlanta did not sign a rehab project.
They signed a goalkeeper with upside - and acknowledged downside.
...
>"Lucas gives us the superiority we need. He has the courage to play when others would just clear it. You need a goalkeeper with that personality to play the way we want."
<cite>Gabriel Heinze</cite>
